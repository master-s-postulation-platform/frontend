                            ...
                            <div className="form__column--2">
                                <label className="form__label" htmlFor="ultimo_grado">
                                    ...
                                    <select name="ultimo_grado" className="form__select"  onChange={e => (setGotten(e.target.value))} value={gotten_grade_id} >
                                        ...
                                        <option value={1} >Bachillerato terminado</option>
                                        <option value={2} >Bachillerato sin terminar</option>
                                        <option value={3} >Carrera terminada</option>
                                        <option value={4} >Carrera sin terminar</option>
                                    </select>
                                </label>
