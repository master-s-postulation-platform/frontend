          ...
          <section className="section__grid">
            ...
            <form className="form">
              <div className="form__column--2">
                <label className="form__label" htmlFor="ultimo_grado">
                  ...
                  <select
                    ...
                    onChange={(e) => setGotten(e.target.value)}
                    value={gotten_grade_id}
                  >
                    {/* <option >Selecciona:</option> */}
                    <option value={1}>Licenciatuara/pregrado terminado</option>
                    <option value={2}>
                      Licenciatuara/pregrado sin terminado
                    </option>
              ...
              <div className="form__footer">
                <button
                  className="secondary__button purple"
                  onClick={submitEducation}
                >
                  Guardar y agregar más
                </button>
                <button className="primary__button green">
                  Guardar y continuar
                </button>
              </div>
            </form>
